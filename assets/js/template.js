function logout() {
  document.cookie = "token=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; domain=.comexpay.co;";
  location.href ='https://comexpay.co';
}
(function($) {
  const nameEl = document.getElementById('personalName1');
  const emailEl = document.getElementById('email1');
  if(localStorage.getItem("name") && localStorage.getItem("email") && emailEl && nameEl){
